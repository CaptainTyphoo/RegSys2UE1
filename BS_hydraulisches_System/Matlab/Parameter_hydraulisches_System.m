...
parSys.Ab = parSys.Aa-parSys.Ds^2*pi/4;   %Fläche Stangenseite
parSys.V0a = 0.7e-3;  %Offsetvolumen Kolbenseite für sk=0

%Öl
parSys.beta = 1.6e9;  %Kompressionsmodul Öl

%Lastmasse
parSys.m = 500;       %Masse des Systems
parSys.dk = 800;      %Dämpfung des Kolbens
